package com.xw.dlnaplayer.service;

import android.content.Intent;
import android.os.IBinder;
import android.util.Log;

import com.xw.dlnaplayer.service.upnp.AndroidJettyServletContainer;
import com.xw.dlnaplayer.service.upnp.ClingContentDirectoryService;
...
public class ClingService extends AndroidUpnpServiceImpl {
    ...
    private void initLocalDevice() {
        ...
        Log.d(TAG, "MediaServer device created! name:%s, manufacturer:%s, model:%s"+"      "+
